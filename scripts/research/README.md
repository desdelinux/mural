...
`chatgpt_voice_probe.py` checks realtime voice through a ChatGPT subscription, using the sign-in session Codex CLI stores on this machine. Findings are in `docs/research/chatgpt-subscription.md`.
